  ...
  return (
    <div className="App">
      <Container component="main">
        ...
        <Chart
          data={getFilteredData(countryRegion)}
        ...
        <Box sx={{ display: "flex", marginTop: 1 }}>
          <Box sx={{ display: "flex", flexDirection: "column", margin: 1 }}>
            ...
            <CountryRegionSelect
              ...
              onCountryRegionChange={handleCountryRegionChange}
            />
            <YAxisToggle
              normalizeYAxis={normalizeYAxis}
              onNormalizeYAxisChange={handleNormalizeYAxisChange}
            />
          </Box>
          ...
          <Box sx={{ margin: 1 }}>
            ...
            <Typography component="section" variant="body2" gutterBottom>
              The data displayed in the chart above is from the International
              IDEA&apos;s{" "}
              <a
                href="https://www.idea.int/gsod-indices/about"
                target="_blank"
                rel="noreferrer"
              >
                Global State of Democracy Indices
              </a>
              . The data measures democratic trends at the country, regional,
              and global levels from 1975-2021 and the researchers have
              distilled their findings into five main democratic attributes, the
              first four of which are included on the chart. The fifth,
              Participatory Engagement, does not offer an aggregate value like
              the others and as such was excluded.
            </Typography>

            <Typography component="section" variant="body2" gutterBottom>
              The options to the left will dynamically update the data
              visualization. You can change the source data to any of the
              countries or regions defined in the indices. You can also change
              the Y-Axis Range to fit the data or consistently show the entire
              scale (0-1).
            </Typography>
          </Box>
        </Box>
